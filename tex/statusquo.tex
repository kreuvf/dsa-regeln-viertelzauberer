...
\begin{table}
	\centering
	\caption[Generierungskosten und ausgewählte Auswirkungen der Vorteile Viertel-, Halb- und Vollzauberer]{Gegenüberstellung der Generierungskosten für Viertel-, Halb- und Vollzauberer und die mit den jeweiligen Vorteilen verbundenen Auswirkungen auf die Astralenergie, die Magieresistenz und die Zahl der vorhandenen Hauszauberer\label{zauberer-gp}}
	\begin{tabular}{lllll}
		\toprule
		Vorteil & Kosten & Astralenergie & Magieresistenz & Hauszauber \\
		\hline
		Viertelzauberer & \SI{5}{\GP} & Grundmenge \SI{-6}{\AsP} & $\pm0$ & 0
